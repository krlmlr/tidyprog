...
This is then handled by capturing the content in a quosure, which can be unquoted by the `!!!`-operator.
You need the "triple-bang" operator here, because the ellipsis can hold more than one variable.
...
We didn't need to capture the content, but it still works, as we can see here:
