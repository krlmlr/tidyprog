...
### Short description of and reading in the data
...
### Exploring the data, visualisations
...
Barplots of number of occurences of `summary` for each city:
...
### Further possibilities of using {dplyr} to transform data
...
Count observations and combinations of specific observations:
...
Use `summarize()` to create tibble with mean and maximum temperature for each city:
