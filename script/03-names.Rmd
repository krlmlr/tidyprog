...
As seen in the ["introduction"](#intro-data), load a table -- here a dictionary detailing information related to an id-like name -- from an MS Excel file with `readxl::read_excel()`:
